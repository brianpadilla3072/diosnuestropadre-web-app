...
export default function CarreraInternado() {
  return (
    <CareerPage
      ...
      description="El Internado Intensivo de Dios Nuestro Padre está diseñado para aquellos que aspiran a convertirse en líderes y mensajeros del corazón de Dios para esta generación. Es una experiencia presencial e inmersiva donde los estudiantes viven en comunidad mientras son entrenados de manera integral."
      ...
      requirements={[
        ...
        "Estudiantes solteros: residencia en dorms de Dios Nuestro Padre",
        "Matrimonios y mayores de 36: vivienda propia",
      ]}
      registrationUrl="https://misioninstituto.quinttos.com/index.php/inscripcion/online/INTERNADO" // TODO: URL inscripción DNP
