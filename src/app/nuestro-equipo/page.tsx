    ...
    <>
      ...
      <main>
              ...
              <div>
                <div className="bg-[#FAFAFA] border border-[#e0e0e0] p-8 mb-6">
                  ...
                  <p className="text-[#545454] leading-relaxed mb-4">
                    Fundador y Director General del Instituto MiSion. Pastor de la Iglesia El Encuentro
          ...
          <div className="max-w-[1260px] mx-auto px-5 md:px-10">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {team.map((member) => (
                <div
                  key={member.name}
                  className="bg-white border border-[#e0e0e0] p-6 hover:border-[#36348E] transition-colors group"
                >
                  <div
                  ...
                  <h3
                    className="font-bold text-[#292929] mb-1 group-hover:text-[#36348E] transition-colors"
        ...
        <section className="py-16 bg-white">
          <div className="max-w-[1260px] mx-auto px-5 md:px-10">
            <div className="bg-[#36348E] text-white p-10 md:p-14 text-center">
              <h2
              ...
              <p className="text-[#B7D8EF] max-w-2xl mx-auto leading-relaxed">
